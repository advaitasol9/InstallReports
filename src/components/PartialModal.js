                ...
                <Button
                  ...
                  onPress={async () => {
                    ...
                    if (!this.props.mainProps.connectionStatus) {
                      ...
                      const data = `text=${this.props.mainProps.comment}&user_ids=[${this.props.mainProps.accountId}]&channel=${(props.userRole == "installer" || props.userRole == "installer-sub") ? "installer":props.userRole}`;
