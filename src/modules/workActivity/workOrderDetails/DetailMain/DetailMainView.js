                  ...
                  }
                  {
                    this.props.activityData.installation_hours_app_active === '1' && (
                      <View>
                        ...
                        <View style={styles.detailDescription}>
                          <Text>
                            {this.props.activityData.installation_hours}
                          </Text>
                        </View>
                      </View>
                    )
                  }
                  {
                    this.props.activityData.union_reqs_app_active === '1' && (
                      <View>
                        ...
                        <View style={styles.detailDescription}>
                          <Text>
                            {this.props.activityData.union_reqs}
                          </Text>
                        </View>
                      </View>
                    )
                  }
                  {
                    this.props.activityData.disposal_reqs_app_active === '1' && (
                      <View>
                        ...
                        <View style={styles.detailDescription}>
                          <Text>
                            {this.props.activityData.disposal_reqs}
                          </Text>
                        </View>
                      </View>
                    )
                  }
                  {
                    this.props.activityData.material_delivery_shipping_app_active === '1' && (
                      <View>
                        ...
                        <View style={styles.detailDescription}>
                          <Text>
                            {this.props.activityData.material_delivery_shipping}
                          </Text>
                        </View>
                      </View>
                    )
                  }
                  {
                    this.props.activityData.specialty_trades_req_app_active === '1' && (
                      <View>
                        ...
                        <View style={styles.detailDescription}>
                          <Text>
                            {this.props.activityData.specialty_trades_req}
                          </Text>
                        </View>
                      </View>
                    )
                  }
                  {
                    this.props.activityData.client_onsite_app_active === '1' && (
                      <View>
                        ...
                        <View style={styles.detailDescription}>
                          <Text>
                            {this.props.activityData.client_onsite}
                          </Text>
                        </View>
                      </View>
                    )
