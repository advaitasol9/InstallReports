...
import {
  addManagerPhoto,
  clearPhotos,
} from "../workOrderQuestions/WorkOrderQuestionsState";
...
export default compose(
  connect(
    ...
    (dispatch) => ({
      ...
      setIncompleteModalVisible: (payload) =>
        dispatch(setIncompleteModalVisible(payload)),
      ...
      if (this.props.connectionStatus) {
        apiGetJson(
          ...
          if (
            ...
            installerAnswers.filter((answer) => answer.answers != "").length ==
              0
          ) {
